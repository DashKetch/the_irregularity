package net.mcreator.theirregularity;
...
@Mod("the_irregularity")
public class TheIrregularityMod {
	public static final Logger LOGGER = LogManager.getLogger(TheIrregularityMod.class);
	public static final String MODID = "the_irregularity";

	public TheIrregularityMod(IEventBus modEventBus) {
